...
{
  *stream->GetStream () << Simulator::Now ().GetSeconds () << "\t" << packet->GetSize () << "\t" << from << std::endl;
}
...
main (int argc, char *argv[])
{
  ...
  TCP Parameters
  **/
  Config::SetDefault ("ns3::TcpSocket::SegmentSize", UintegerValue (1200)); // Standard MSS
  ...
  **/
  ...
  Config::SetDefault ("ns3::McUeNetDevice::Mtu", UintegerValue(1400));
  ...
  building1->SetBoundaries (Box (4.0,5.0,
                                  2, 4,
                                  0.0, 8.0));
  ...
  building2->SetBoundaries (Box (9.0,10.0,
                                  2, 4,
                                  0.0, 8.0));
  ...
  building3->SetBoundaries (Box (14.0,15.0,
                                  2, 4,
                                  0.0, 8.0));
  ...
  building3->SetNRoomsX (3);
  building3->SetNRoomsY (2);
    
  // Create UE, LTE eNB and mmWave eNB nodes
  ...
  enbPositionAlloc->Add (Vector (9.0, 10.0, 4.0)); // mmWave 1
  // enbPositionAlloc->Add (Vector (130, 0.0, 10.0)); // mmWave 2
  ...
  **/
  ...
  Simulator::Schedule (Seconds (0), &ChangeSpeed, ueNodes.Get (0), Vector (1.4, 0, 0)); // start UE movement after Seconds(0.0)
