...
main (int argc, char *argv[])
{
  ...
  **/
  ...
  Config::SetDefault ("ns3::MmWavePhyMacCommon::NumHarqProcess", UintegerValue (100)); // NEED CHANGED
  ...
  **/
  ...
  double stopTime = 16.5;
  double simStopTime = 16.5;
  ...
  **/
  ...
  Simulator::Schedule (Seconds (1), &ChangeSpeed, ueNodes.Get (0), Vector (1.4, 0, 0)); // start UE movement after Seconds(0.0)
